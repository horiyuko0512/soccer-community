...
type SearchMatchInput struct {
	Date            *time.Time   `json:"date,omitempty"`
	StartTime       *time.Time   `json:"startTime,omitempty"`
	EndTime         *time.Time   `json:"endTime,omitempty"`
	Location        *string      `json:"location,omitempty"`
	Level           *match.Level `json:"level,omitempty"`
	ParticipantsMin *int32       `json:"participantsMin,omitempty"`
	ParticipantsMax *int32       `json:"participantsMax,omitempty"`
	FeeMin          *int32       `json:"feeMin,omitempty"`
	FeeMax          *int32       `json:"feeMax,omitempty"`
	IsApplied       *bool        `json:"isApplied,omitempty"`
}
