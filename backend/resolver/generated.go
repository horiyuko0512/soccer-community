...
func (ec *executionContext) _Match_date(ctx context.Context, field graphql.CollectedField, obj *model.Match) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Match_date(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) unmarshalInputCreateMatchInput(ctx context.Context, obj any) (model.CreateMatchInput, error) {
	...
	fieldsInOrder := [...]string{"title", "date", "location", "level", "participants", "fee", "notes", "createdAt", "updatedAt", "isApplied", "creatorID", "matchParticipationIDs"}
...
func (ec *executionContext) unmarshalInputUpdateMatchInput(ctx context.Context, obj any) (model.UpdateMatchInput, error) {
	...
	fieldsInOrder := [...]string{"title", "date", "location", "level", "participants", "fee", "notes", "updatedAt", "isApplied", "creatorID", "addMatchParticipationIDs", "removeMatchParticipationIDs", "clearMatchParticipation"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
