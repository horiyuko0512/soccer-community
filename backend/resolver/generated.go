...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.searchMatches":
		if e.complexity.Query.SearchMatches == nil {
			break
		}

		args, err := ec.field_Query_searchMatches_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SearchMatches(childComplexity, args["input"].(model.SearchMatchInput)), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		...
		ec.unmarshalInputSearchMatchInput,
...
func (ec *executionContext) field_Query_searchMatches_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_searchMatches_argsInput(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Query_searchMatches_argsInput(
	ctx context.Context,
	rawArgs map[string]any,
) (model.SearchMatchInput, error) {
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNSearchMatchInput2githubᚗcomᚋhoriyuko0512ᚋsoccerᚑcommunityᚋresolverᚋmodelᚐSearchMatchInput(ctx, tmp)
	}

	var zeroVal model.SearchMatchInput
	return zeroVal, nil
}
...
func (ec *executionContext) _Query_searchMatches(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_searchMatches(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SearchMatches(rctx, fc.Args["input"].(model.SearchMatchInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_searchMatches(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_searchMatches_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputSearchMatchInput(ctx context.Context, obj any) (model.SearchMatchInput, error) {
	var it model.SearchMatchInput
	asMap := map[string]any{}
	for k, v := range obj.(map[string]any) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"date", "startTime", "endTime", "location", "level", "participantsMin", "participantsMax", "feeMin", "feeMax", "isApplied"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "participantsMin":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("participantsMin"))
			data, err := ec.unmarshalOInt2ᚖint32(ctx, v)
			if err != nil {
				return it, err
			}
			it.ParticipantsMin = data
		case "participantsMax":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("participantsMax"))
			data, err := ec.unmarshalOInt2ᚖint32(ctx, v)
			if err != nil {
				return it, err
			}
			it.ParticipantsMax = data
		case "feeMin":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("feeMin"))
			data, err := ec.unmarshalOInt2ᚖint32(ctx, v)
			if err != nil {
				return it, err
			}
			it.FeeMin = data
		case "feeMax":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("feeMax"))
			data, err := ec.unmarshalOInt2ᚖint32(ctx, v)
			if err != nil {
				return it, err
			}
	...
	for i, field := range fields {
		...
		case "searchMatches":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_searchMatches(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) unmarshalNSearchMatchInput2githubᚗcomᚋhoriyuko0512ᚋsoccerᚑcommunityᚋresolverᚋmodelᚐSearchMatchInput(ctx context.Context, v any) (model.SearchMatchInput, error) {
	res, err := ec.unmarshalInputSearchMatchInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
