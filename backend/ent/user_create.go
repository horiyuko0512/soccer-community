...
func (uc *UserCreate) AddMatchIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddMatchIDs(ids...)
	return uc
}

// AddMatches adds the "matches" edges to the Match entity.
func (uc *UserCreate) AddMatches(m ...*Match) *UserCreate {
...
func (uc *UserCreate) AddUserParticipationIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddUserParticipationIDs(ids...)
	return uc
}

// AddUserParticipation adds the "user_participation" edges to the Participation entity.
func (uc *UserCreate) AddUserParticipation(p ...*Participation) *UserCreate {
	ids := make([]uuid.UUID, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return uc.AddUserParticipationIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.UserParticipationIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
