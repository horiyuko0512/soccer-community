    ...
    <div className="min-h-screen bg-sky-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-sky-900 mb-4">近所でサッカーを楽しもう！</h1>
          <p className="text-lg text-sky-700 mb-6">
            地域のサッカー仲間とつながり、一緒に試合を楽しみましょう
          </p>
          <Button
            className="w-full md:w-auto bg-sky-500 hover:bg-sky-600 text-lg px-8 py-4 mb-8"
        ...
        <div className="space-y-4 md:grid md:grid-cols-3 md:gap-6 md:space-y-0">
          <Card className="p-4">
            <CardContent>
              ...
              <p className="text-sky-600">お近くのサッカー仲間とすぐに試合の約束ができます</p>
            </CardContent>
          </Card>
          <Card className="p-4">
            <CardContent>
          ...
          <Card className="p-4">
            <CardContent>
              ...
              <p className="text-sky-600">試合場所の共有も簡単。集合場所に迷うことはありません</p>
            </CardContent>
          </Card>
        </div>
      </main>
